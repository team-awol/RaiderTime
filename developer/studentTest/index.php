...
<div class="g-signin2" data-onsuccess="onSignIn" style="visibility: hidden;"></div>
    ...
    auth2.signOut().then(function () {
        ...
        function goAdmin() {
            window.location.replace("http://ahsraidertime.com/administrator");
        }
        
        function goAddDevelopers() {
            window.location.replace("http://ahsraidertime.com/administrator/addDevelopers.php");
        }
        function goTesting() {
            window.location.replace("http://ahsraidertime.com/administrator/studentTest");
        }
    </script>
        <div class="body">
           ...
           // cant get room number
                    ...
                    <?php 
                        ...
                        if($result->num_rows > 0) {
                            ...
                            echo "<button class=button onclick=goAddDevelopers();>Add Developers(DO NOT CLICK)</button>";
                            echo "<button class=button onclick=goTesting();>Go to Testing Page</button>";
                        }
                    ?>
                 </div>
